  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      group = {
        ...
        "col.border_active" = "rgb(7A7A7A)";
        "col.border_inactive" = "rgb(505050)";

        "col.border_locked_active" = "rgb(BF0000)";
        "col.border_locked_inactive" = "rgb(#750000)";
        ...
        groupbar = {
          ...
          "col.active" = "rgb(7A7A7A)";
          "col.inactive" = "rgb(505050)";

          "col.locked_active" = "rgb(BF0000)";
          "col.locked_inactive" = "rgb(750000)";
        };
      };
      ...
      bind = [
        ...
        "$mod, /, exec, bash ~/.local/bin/command_menu.sh"
