...
# Packages
sudo pacman -S --noconfirm noto-fonts noto-fonts-extra noto-fonts-emoji noto-fonts-cjk ttf-cascadia-code unzip unrar 7zip stow nushell firefox chromium lazygit zed pinta zed neovim kitty udiskie dunst feh docker docker-compose xdg-desktop-portal xdg-desktop-portal-gtk ttf-liberation
